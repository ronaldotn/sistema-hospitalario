<template>
  ...
  <div class="d-flex flex-wrap gap-3 align-center flex-grow-1 justify-start ">
    ...
    <VTextField v-model="quickFilters.last_name" label="Apellido" placeholder="Doe"
                prepend-inner-icon="bx-user" density="comfortable" clearable style="min-width:180px; max-width:250px"/>
    <VTextField v-model="quickFilters.specialty" label="Especialidad" placeholder="Cardiología"
                prepend-inner-icon="bx-stethoscope" density="comfortable" clearable style="min-width:180px; max-width:250px"/>
    <VSelect v-model="quickFilters.active" :items="[{title:'Activo', value:1},{title:'Inactivo', value:0}]" label="Estado" clearable style="min-width:120px; max-width:150px"/>
